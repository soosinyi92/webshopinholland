        ...
        <ItemTemplate>
            <tr class="row">
                ...
                <td class="action">
                    ...
                    <asp:LinkButton ID="lbtnDelete" runat="server" Text="Remove" OnCommand="lbtnDelete_Click" CommandArgument=<%# Eval("EventId") %> ToolTip="Delete"></asp:LinkButton>
                </td>
            </tr>
        </ItemTemplate>
        <FooterTemplate>
            <tr>
                ...
                <td>
                    <asp:LinkButton ID="lbtnDeleteAll" runat="server" Text="Remove All" OnClick="lbtnDeleteAll_Click" ToolTip="Delete All"></asp:LinkButton>
                </td>
            </tr>
            </table>
