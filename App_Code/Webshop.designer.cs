...
public partial class Discount : INotifyPropertyChanging, INotifyPropertyChanged
{
	...
	[Column(Storage="_DiscountID", AutoSync=AutoSync.OnInsert, DbType="Int NOT NULL IDENTITY", IsPrimaryKey=true, IsDbGenerated=true)]
...
public partial class Image : INotifyPropertyChanging, INotifyPropertyChanged
{
	...
	[Column(Storage="_ImageID", AutoSync=AutoSync.OnInsert, DbType="BigInt NOT NULL IDENTITY", IsPrimaryKey=true, IsDbGenerated=true)]
	public long ImageID
	{
		get
		{
